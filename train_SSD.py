...
def get_args_parser():
    ...
    parser.add_argument('--project_name', type=str, default='SSD', help='Name of the project for logging purposes.')
...
def train(args) -> None:
    ...
    logging_name = f"{args.project_name}_{train_dirs_str.replace('/', '_')}_{args.sub_name}_{args.use_sampler}_{args.batch_size}_{args.batches_per_epoch}"
    ...
    csv_logger = pl_loggers.CSVLogger(os.path.join(args.log_dir, 'SSD', train_dirs_str,''))
...
if __name__ == "__main__":
    ...
    # Initialize wandb
    wandb.init(project=f"{args.project_name}", name=f"{args.project_name}_{train_dirs_str}_{args.sub_name}")
