...
def get_args_parser():
    ...
    parser.add_argument('--checkpoint_path', type=str, required=True, help='Path to the pre-trained checkpoint for fine-tuning.')

    return parser

def fine_tune(args) -> None:
    # Print all parameters before fine-tuning
    ...
    # Start the fine-tuning process with the defined model and data module
    trainer.fit(model, data_module)

if __name__ == "__main__":
    # Parse command-line arguments
    parser = argparse.ArgumentParser('Detection Head fine-tuning script', parents=[get_args_parser()])
