...
if __name__=='__main__':
    ...
    for model_name, sam_version, logging_name in [
        ...
        # ('segmentation_anchor_detr_1200_best', 'sam1', 'anchor_detr_1200_best'),
        # ('segmentation_frcnn_v2_1200_best', 'sam1', 'frcnn_v2_1200_best'),
        ('segmentation_anchor_detr_sam_base_1200_best', 'sam1', 'anchor_detr_sam_base_1200_best'),
    ]:
